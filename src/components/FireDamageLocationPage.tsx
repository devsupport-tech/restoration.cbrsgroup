...
import { Phone, Clock, Shield, CheckCircle, MapPin, Flame } from "lucide-react";
import { Link } from "react-router-dom";

interface FireDamageLocationPageProps {
  city: string;
  county?: string;
  metaTitle: string;
...
const FireDamageLocationPage = ({
  ...
  const whyChooseUs = [
    { title: "24/7 Emergency Response", description: `Fast response times throughout ${city} when you need us most` },
    { title: "Licensed & Insured", description: "Fully licensed, bonded, and insured for your protection" },
    { title: "Insurance Experts", description: "We work directly with your insurance company to maximize your claim" },
    { title: "One Contractor", description: "From board-up to full rebuild - one team, one point of contact" },
    { title: "Certified Technicians", description: "IICRC certified fire and smoke restoration specialists" },
    { title: "Free Estimates", description: "No-obligation assessments for all fire damage situations" },
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`https://restoration.cbrsgroup.com/fire-damage/${city.toLowerCase().replace(/\s+/g, '-')}`} />
        <meta property="og:title" content={metaTitle} />
        <meta property="og:description" content={metaDescription} />
        <meta property="og:url" content={`https://restoration.cbrsgroup.com/fire-damage/${city.toLowerCase().replace(/\s+/g, '-')}`} />
      </Helmet>
      ...
      <div className="min-h-screen">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-heading font-bold text-foreground mb-8 text-center">
                Fire Damage Restoration Services in {city}
              </h2>
        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-heading font-bold text-foreground mb-8 text-center">
                Common Causes of Fire Damage in {city}
              </h2>
              <div className="grid md:grid-cols-2 gap-6">
                {commonCauses.map((cause, index) => (
                  <div key={index} className="flex items-start gap-3">
                    <Flame className="h-5 w-5 text-accent mt-1 shrink-0" />
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl font-heading font-bold text-accent-foreground mb-4">
                Need Fire Damage Restoration in {city}?
              </h2>
              <p className="text-accent-foreground/80 mb-8">
                Don't wait — smoke and soot damage gets worse over time. Call now for immediate 24/7 emergency response.
              </p>
              <a
                href="tel:8326080535"
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto">
                <h3 className="text-xl font-heading font-semibold text-foreground mb-4 text-center">
                  Fire Damage Restoration in Nearby Areas
                </h3>
                <div className="flex flex-wrap justify-center gap-3">
                  {nearbyAreas.map((area) => (
                    <Link
                      key={area.slug}
                      to={`/fire-damage/${area.slug}`}
...
export default FireDamageLocationPage;
