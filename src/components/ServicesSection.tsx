import { Flame, Droplets, Home, Zap, GlassWater, Construction } from "lucide-react";
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service) => (
            <div
              key={service.title}
              className="rounded-2xl bg-card p-8 shadow-sm hover:shadow-md transition-shadow group"
            >
