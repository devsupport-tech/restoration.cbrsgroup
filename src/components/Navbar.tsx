...
const socialLinks = [
  { href: "https://www.facebook.com/profile.php?id=61564870028363", icon: Facebook, label: "Facebook" },
  { href: "https://www.instagram.com/cbrsgroup", icon: Instagram, label: "Instagram" },
  { href: "https://www.tiktok.com/@cbrs.group", icon: TikTokIcon, label: "TikTok" },
  { href: "https://youtube.com/@cbrsgroup", icon: Youtube, label: "YouTube" },
];
      ...
      {mobileOpen && (
        <div className="md:hidden bg-background border-t border-border">
          <div className="px-4 py-2">
            ...
            <div className="flex items-center justify-center gap-4 py-3 border-t border-border/50">
              {socialLinks.map((social) => (
                <a
                  key={social.label}
                  href={social.href}
